...
% planeZvals = linspace(0.6, 1.6, 3);
planeZvals = linspace(0.5, 1.5, 2);
...
hfig1 = figure(1);
    ...
    set([hTitle1,hTitle2],'FontName','CMU Serif','FontSize',14);
    set([hs1,hs2],'View',[-105,13]);
    set(hfig1,'Color','w');
